...
2026-07-20T12:10:00+07:00 | event=consult-complete | session=6b48be89 | round=1 | verdict=find-holes | tokens=NA | time=54.8s | models=codex,grok,agy | web= | survivors=2/3 | failures=Grok:timeout | legtimes=GPT:31.2,Grok:180.0,Gemini:44.9 | agy_model=gemini-3.6-flash-high | codex_effort=medium | project=/path/to/repo
```
